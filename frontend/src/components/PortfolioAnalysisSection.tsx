...
/* ─── Main Component ─────────────────────────────── */
export default function PortfolioAnalysisSection({ holdings: _holdings, accountFilter: _accountFilter }: Props) {
  ...
  return (
    <div>
      ...
      {/* Loading skeleton */}
      {!error && loading && <AnalysisSkeleton />}
